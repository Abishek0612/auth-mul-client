...
import POWorkspace from "./pages/POWorkspace";
import InvoiceWorkspace from "./pages/InvoiceWorkspace";
import GRNWorkspace from "./pages/GRNWorkspace";
      ...
      >
        ...
        <div className="p-2 sm:p-4 lg:p-6 w-full relative">
          <Routes>
            ...
            <Route path="po-workspace" element={<POWorkspace />} />
            <Route path="invoice-workspace" element={<InvoiceWorkspace />} />
            <Route path="grn-workspace" element={<GRNWorkspace />} />
