...
const DocumentLibrary = () => {
  ...
  const [activeSubTab, setActiveSubTab] = useState(
    searchParams.get("subTab") || "invoice"
  );
  ...
  const updateURLParams = useCallback(() => {
    ...
    if (activeSubTab !== "invoice") params.set("subTab", activeSubTab);
        ...
        if (response.success) {
          ...
          if (
            ...
            if (selectedType === "All Types") {
              setDocumentCounts((prev) => ({
                ...prev,
                approved: response.pagination?.total || 0,
              }));
            } else if (selectedType === "Invoice") {
              setDocumentCounts((prev) => ({
                ...prev,
                approvedInvoice: response.pagination?.total || 0,
              }));
            } else if (selectedType === "Purchase Order") {
              setDocumentCounts((prev) => ({
                ...prev,
                approvedPO: response.pagination?.total || 0,
              }));
            } else if (selectedType === "GRN") {
              setDocumentCounts((prev) => ({
                ...prev,
                approvedGRN: response.pagination?.total || 0,
              }));
            } else if (selectedType === "Payment Advice") {
              setDocumentCounts((prev) => ({
                ...prev,
                approvedPaymentAdvice: response.pagination?.total || 0,
              }));
            }
          }
        }
  ...
  const handleTabChange = (tab, subTab = "invoice") => {
    setActiveTab(tab);
